...
import com.ljq.privatefiledemo.databinding.ActivityMultiBinding;
import com.ljq.privatefiledemo.mutil.DownloadNumDialog;
import com.ljq.privatefiledemo.mutil.FileListEntity;
...
public class MultiTaskListActivity extends BaseActivity<ActivityMultiBinding> {
  private final static String TAG = MultiTaskListActivity.class.getSimpleName();
  RecyclerView mList;
  Toolbar mBar;
